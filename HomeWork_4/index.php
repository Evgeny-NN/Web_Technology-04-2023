...
$experience = [
    [
        "name"=> "Разработчик андроид",
        "dateStert" => "январь 2015",
        "dateEnd"=> "Текущее время",
        "description" => "Привет",
    ],
    [
        "name"=> "Веб- разработчик / something.com",
        "dateStert" => "март 2016",
        "dateEnd"=> "февраль 2023",
        "description" => "Как дела", 
    ],
    [
        "name"=> "рафический дизайнер / designsomething.com",
        "dateStert" => "Июнь 2021",
        "dateEnd"=> "март 2023",
        "description" => "Свёкла",
    ],
        ...
        <?php for ($i = 0; $i < count($experience); $i++): ?>
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal">
                ...
                <?php echo $experience [$i]['dateStert']?> - 
                <?php if($i == 0):?>
                <span class="w3-tag w3-teal 
                w3-round"><?php echo $experience [$i]['dateEnd']?></span></h6>
                <?php else: ?><?php echo $experience [$i]['dateEnd'];?>
                  <?php endif; ?>
